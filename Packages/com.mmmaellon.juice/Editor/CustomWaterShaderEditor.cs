...
namespace MMMaellon
{
    public class WaterClippedEditor : ShaderGUI
    {

        GUIContent texLabel = new GUIContent("Base Color");
        GUIContent clipLabel = new GUIContent("Clip Texture");
        ...
        MaterialProperty _ClipTex = null;
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                Action surfaceTabAction = () =>
                {
                    ...
                    MGUI.PropertyGroup(() =>
                    {
                        ...
                        me.TexturePropertySingleLine(clipLabel, _ClipTex);
